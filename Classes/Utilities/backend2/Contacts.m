...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	{
		NSString *numberPartial = [labeledValue.value valueForKey:@"digits"];
		NSString *numberComplete = numberPartial;	// You need to call your 'partial number to complete number' method here
		[numbers addObject:numberComplete];
	}
	contact[@"numbers"] = numbers;
	//---------------------------------------------------------------------------------------------------------------------------------------------
	NSMutableArray *emails = [[NSMutableArray alloc] init];
	for (CNLabeledValue *labeledValue in cncontact.emailAddresses)
	{
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	temp[@"emails"] = [contact[@"emails"] componentsJoinedByString:@","];
	//---------------------------------------------------------------------------------------------------------------------------------------------
