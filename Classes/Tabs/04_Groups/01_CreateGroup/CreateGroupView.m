...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	if ([text length] != 0)
	{
		...
		predicate = [NSPredicate predicateWithFormat:format, [FUser currentId], blockerIds, numbers, text];
	}
	else
	{
		NSString *format = @"objectId != %@ AND NOT objectId IN %@ AND phone IN %@";
		predicate = [NSPredicate predicateWithFormat:format, [FUser currentId], blockerIds, numbers];
	}
	//---------------------------------------------------------------------------------------------------------------------------------------------
