...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	CallAudioView *callAudioView = [[CallAudioView alloc] initWithUserId:dbuser.objectId];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	CallVideoView *callVideoView = [[CallVideoView alloc] initWithUserId:dbuser.objectId];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	[Blocked createItem:userId];
	[Blocker createItem:userId];
	//---------------------------------------------------------------------------------------------------------------------------------------------
