...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	//---------------------------------------------------------------------------------------------------------------------------------------------
	chatId = [Chat chatIdPrivate:recipientId];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	[MessageQueue send:chatId recipientId:recipientId status:nil text:text picture:picture video:video audio:audio];
	//---------------------------------------------------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	CallAudioView *callAudioView = [[CallAudioView alloc] initWithUserId:recipientId];
	[self presentViewController:callAudioView animated:YES completion:nil];
}
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	CallVideoView *callVideoView = [[CallVideoView alloc] initWithUserId:recipientId];
	[self presentViewController:callVideoView animated:YES completion:nil];
}
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	if (rcmessage.type == RC_TYPE_AUDIO)
	{
		...
		if (rcmessage.status == RC_STATUS_SUCCEED)
		{
			...
			{
				Sound *sound = [Sound soundWithContentsOfFile:rcmessage.audio_path];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	indexForward = [RCMenuItem indexPath:sender];
	//---------------------------------------------------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	DBMessage *dbmessage = [self dbmessage:indexForward];
	//---------------------------------------------------------------------------------------------------------------------------------------------
	for (DBUser *dbuser in users)
	{
		NSString *recipientId = dbuser.objectId;
		NSString *chatId = [Chat chatIdPrivate:recipientId];
		[MessageQueue forward:chatId recipientId:recipientId dbmessage:dbmessage];
	}
	//---------------------------------------------------------------------------------------------------------------------------------------------
