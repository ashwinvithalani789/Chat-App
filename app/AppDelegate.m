...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	if (call.details.isVideoOffered)
	{
		...
		[window.rootViewController presentViewController:callVideoView animated:YES completion:nil];
	}
	else
	{
		CallAudioView *callAudioView = [[CallAudioView alloc] initWithCall:call];
		UIWindow *window = [[UIApplication sharedApplication] keyWindow];
		[window.rootViewController presentViewController:callAudioView animated:YES completion:nil];
	}
}
